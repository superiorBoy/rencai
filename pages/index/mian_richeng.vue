<template>
	<view class="body">
		<view class="head">
			...
			<view class=" head_right hei_30_bold"><navigator url="mian_jilu">全部</navigator></view>
		</view>
		...
		<view class="zi_body">
			...
			<view class="richeng_list" v-if="is_mianshi">
				<view class="richeng_item">
					...
					<view class="richeng_item_right">
						<view class="richeng_item_right_top">
							<text class="hei_32_bold">巨星科技</text>
				...
				<view class="richeng_item">
					...
					<view class="richeng_item_right">
						<view class="richeng_item_right_top">
							<text class="qian_32_bold">纳思教育</text>
				...
				<view class="richeng_item">
					...
					<view class="richeng_item_right">
						<view class="richeng_item_right_top">
							<text class="hei_32_bold">金烽信息科技有限公司</text>
