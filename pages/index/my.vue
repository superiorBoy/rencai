<template>
	<view class="body">
		<view class=" my_body">
			<view class="my_top_body">
				<view class="my_top">
					<view class="my_top_left">
						<view class="my_top_left_r" v-if="is_login">
							<view class="my_name ">
								<text class="bai_40_bold">{{user.nickname}}</text>
								<view class="bai_24 my_name_jianli" @click="tiaozhuan('jianli')">
									<image src="../../static/index_img/my_jianli.png" mode=""></image>
									我的在线简历
								</view>
							</view>
						</view>
						<view class="my_top_weoienglu bai_26" v-if="!is_login">
							<navigator url="login_xuanze?title=1" class="go_denglu">登录</navigator>
							<navigator url="login_xuanze?title=2" class="go_denglu">注册</navigator>
						</view>
					</view>
					<view class="my_top_right bai_24">
				...
				<view class="tongzhi"><image src="../../static/index_img/kaitong.png" mode=""></image></view>
			</view>
			...
			<view class="my_bottom">
				<view class="my_zhiwei">
					<view class="my_zhiwei_item hei_24" @click="tiaozhuan('jianli')">
						...
						<view class="my_zhiwei_item_bottom">简历管理</view>
					</view>
					...
					<view class="my_zhiwei_item hei_24" @click="tiaozhuan('yixiang')">
						...
						<view class="my_zhiwei_item_bottom">求职意向</view>
					</view>
					<view class="my_zhiwei_item hei_24" @click="tiaozhuan('yinsi')">
						...
						<view class="my_zhiwei_item_bottom">隐私设置</view>
					</view>
					<view class="my_zhiwei_item hei_24" @click="tiaozhuan('zhuye')">
						<image src="../../static/index_img/my_top4.png" mode="" style="width: 68rpx;height: 72rpx;"></image>
						<view class="my_zhiwei_item_bottom">个人主页</view>
					</view>
				</view>

				<view class="my_caozuo">
					<view class="my_caozuo_item" @click="tiaozhuan('search')">
						<image src="../../static/index_img/my_shuaxin.png" mode="" style="width: 45rpx;height: 52rpx;"></image>
						<view class="my_caozuo_item_right">
							<view class="hei_26_bold ">简历刷新</view>
							<view class="qian_22 my_caozuo_item_title">提升简历的活跃度</view>
						</view>
					</view>
					<view class="my_caozuo_item" @click="tiaozhuan('zhiding')">
						<image src="../../static/index_img/my_jingzheng.png" mode="" style="width: 56rpx;height: 52rpx;"></image>
						<view class="my_caozuo_item_right">
							<view class="hei_26_bold ">竞争力分析</view>
							<view class="qian_22 my_caozuo_item_title">了解行业的竞争</view>
						</view>
					</view>
				</view>
				...
				<view class="my_guanli tuiguang_guanli">
					...
					<view class="my_list">
						...
						<view class="zhanghao_item">
							<image src="../../static/index_img/tuiguang2.png" mode=""></image>
							<view class="hui_24 ">我的奖励</view>
						</view>
						<view class="zhanghao_item">
							<image src="../../static/index_img/tuiguang3.png" mode=""></image>
							<view class="hui_24 ">我的团队</view>
						</view>
						<view class="zhanghao_item">
							<image src="../../static/index_img/tuiguang4.png" mode=""></image>
...
.my_guanli {
	...
	margin-bottom: 30rpx;
	box-shadow: 0px 0px 16px 0px rgba(158, 158, 158, 0.18);
	border-radius: 10px;
}
...
.zhanghao_guanli {
	margin-bottom: 30rpx;
	box-shadow: 0rpx 0rpx 16rpx 0rpx rgba(158, 158, 158, 0.18);
	border-radius: 10rpx;
...
.my_caozuo_item {
	...
	height: 130rpx;
	background-color: #ffffff;
	box-shadow: 0rpx 0rpx 29rpx 0rpx rgba(136, 136, 136, 0.17);
	border-radius: 5rpx;
	display: flex;
	align-items: center;
	padding-left: 20rpx;
...
.my_caozuo_item_right {
	margin-left: 26rpx;
}
.my_caozuo_item_title {
	margin-top: 6rpx;
	transform: scale(0.9);
	position: relative;
	left: -10rpx;
